// app/(dashboard)/diagnostic/profile/page.tsx
"use client";
                  ...
                  <div className="flex flex-wrap gap-2">
                    {servicesOffered.length > 0 ? (
                      servicesOffered.map((service, index) => (
                        <Badge key={index} className="bg-[#e5eeff] text-[#515f78] hover:bg-[#e5eeff]/80 px-3 py-1">
                          {service}
                          {isEditing && (
                            <button 
                  ...
                  {isEditing && (
                    <div className="flex gap-2 mt-2">
                      ...
                      <Button 
                        variant="outline" 
                        onClick={addService}
                        className="border-[#006767] text-[#006767] hover:bg-[#006767] hover:text-white"
                      >
              ...
              <div className="flex items-center justify-between p-4 bg-[#F1F5F9] rounded-xl">
                <div>
                  ...
                  <p className="text-xs text-[#3d4949]">
                    {diagnosticProfile?.license_document ? "Uploaded" : "Not uploaded"}
                  </p>
                </div>
                <Button
                  variant="outline"
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        your data from our servers. All your patients, test results, and staff data will be lost forever.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
