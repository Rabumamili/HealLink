    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white pb-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8">
        ...
        <AppointmentHeader
          ...
          description="Manage all patient appointments, verify payments, handle check-ins, and track consultation progress. View detailed service information for each appointment."
