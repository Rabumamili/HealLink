...
export default function DoctorCheckinPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-teal-600">Doctor Check-in</h1>
                ...
                <div className={cn(
                  ...
                  {checkInSuccess || checkInResult?.success ? (
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-green-600">Please proceed to the consultation room</p>
                    </div>
                ...
                {doctorCards.slice(0, 5).map((card) => (
                  <div key={card.id} className="flex items-center justify-between p-3 rounded-lg border hover:border-teal-200 transition-colors">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{card.appointment?.serviceName || "Consultation"}</p>
                    </div>
