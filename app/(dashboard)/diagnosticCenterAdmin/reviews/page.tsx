...
// Get current diagnostic center ID
const getCurrentDiagnosticId = (): number => {
  ...
  return 104; // Default diagnostic center ID
};
...
// Review Card for Diagnostic Center View
const DiagnosticReviewCard = ({ review }: { review: any }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-20">
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8">
        ...
        <PageHeader
          ...
          subtitle="Patient feedback about your lab services and test accuracy"
          actions={
            <Button
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold">{providerStats?.provider_name || 'Diagnostic Center'}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Accuracy Rating</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Patient Trust</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Lab Performance Metrics</CardTitle>
              ...
              <div className="flex gap-2 flex-wrap">
                {[5, 4, 3, 2, 1].map(star => (
                  <Button
                    ...
                    className={ratingFilter === star ? 'bg-violet-600 hover:bg-violet-700' : 'border-gray-200'}
                  >
        ...
        <div className="space-y-4">
          {filteredReviews.length > 0 ? (
            filteredReviews.map((review) => (
              <DiagnosticReviewCard key={review.review_id} review={review} />
            ))
          ) : (
            <EmptyState
              variant="review"
              ...
              actionHref="/diagnosticCenter/profile"
            />
          )}
        </div>
      </div>
