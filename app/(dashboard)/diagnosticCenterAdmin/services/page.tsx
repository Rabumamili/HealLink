  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden p-4 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-primary">Diagnostic Tests</h1>
          <p className="text-gray-600 text-sm">Manage lab services</p>
        </div>
      ...
      <ServiceFormModal
        ...
        title="Add Test"
        description="Create diagnostic service"
      />
